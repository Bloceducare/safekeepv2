...
const Benefit = ({bgColor, topic, text, containerLeft, bgImage, BgSvg, firstContainer}: BenefitProps) => {
  return (
  <div className={`w-full overflow-hidden flex flex-col items-end max-w-[725px] h-[725px] rounded-[19px] self-start mt-8 ${bgColor} ${containerLeft? "lg:self-start lg:mr-9" : "lg:self-end"} ${firstContainer? "": "lg:-mt-32"}`}>
