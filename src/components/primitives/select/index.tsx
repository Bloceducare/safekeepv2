...
export const SelectOption: React.FC<SelectOptionProps> = ({ children, value, disabled }) => (
...
const Select = ({ children, onChange, onBlur, placeholder, name, required, disabled, value, className, variant, width = "100%", arrowLeft = false }: SelectProps): JSX.Element => {
    ...
    <div className="w-full pb-0 h-full relative">
      ...
      >
        <SelectPrimitive.SelectTrigger
          ...
          className={` focus:border-none border-0 rounded-none ${className} `}
          aria-label={name}
          disabled={disabled}
          aria-disabled={disabled}
        >
        ...
        <div className="relative">
          ...
          >
            <SelectPrimitive.SelectScrollUpButton className="flex text-white bg-[#9db8d1] justify-center items-center cursor-default">{/* <ChevronUpIcon /> */}</SelectPrimitive.SelectScrollUpButton>
            ...
            <SelectPrimitive.SelectScrollDownButton className="flex text-white bg-[#9db8d1] justify-center items-center cursor-default">
              {/* <ChevronDownIcon /> */}
            </SelectPrimitive.SelectScrollDownButton>
          </SelectPrimitive.Content>
        </div>
      </SelectPrimitive.Root>
      {formContext?.errors[name]?.type === "required" && <FormAlert>This field is required</FormAlert>}
    </div>
  );
};
