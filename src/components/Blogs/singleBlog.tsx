...
const SingleBlog = () => {
  return (
    <div className="max-w-[346px] w-full">
      ...
      <p
        className="mt-5 text-2xl font-polySansTrial"
        style={{
      ...
      >
        Updates on the $50M Buyback Program
      </p>
      ...
      <p className="mt-4">
        <span className="text-xs font-light font-polySansTrial text-safekeep-blue">Safekeep Team</span>
        <span>✨</span>
        <span className="font-polySansTrial text-xs text-[#B5B5B5] font-light">October 21, 2022</span>
      </p>
      <div className="mt-5">
        <Link href="/blog/more" className="mt-5 border border-solid border-safekeep-blue rounded-lg py-1.5 px-5 font-paralucentLight text-safekeep-blue text-base">
          Read more
        </Link>
      </div>
    </div>
