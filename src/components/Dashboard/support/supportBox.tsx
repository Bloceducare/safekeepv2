...
<div className="flex">
    <Icon />
<div className="text-safekeep-blue-500 font-paralucentMedium ml-1"> 
{title}
</div>

</div>

<div className="text-safe-dark-300 text-sm my-4">
   {description}
     </div>
</div>
 </>
...
export const SupportBodyContainer = ({children})=>{
    return <div className="bg-safekeep-white w-full p-5 rounded-[8px]">
    {children}
    </div>
}
