    ...
    <div className="">
      ...
      <div className="flex gap-2">
        <div className="w-full max-w-[40%] relative">
          ...
          <div className=" z-[3000] relative py-3.5 h-[60px] px-2 bg-[#F8F8F8] rounded-lg w-full">
            <Select name="assetType" className="flex items-center relative">
        ...
        <div className="w-full max-w-[60%]">
          ...
          <div className="w-full flex gap-2 h-[60px] items-center bg-safekeep-hover rounded-lg">
            <Input name="balance" className="w-full h-full border-none focus:border-none" value="23 USDT" />
          </div>
        </div>
      </div>
