    ...
    return (
        <div className="">
            <div className="flex flex-col gap-1.5 py-3">
                ...
                <p className="text-sm font-dmSans text-[#606060]">Add additional Vault signatories and specify how many of them have to confirm a transaction before it gets executed.</p>
            </div>
