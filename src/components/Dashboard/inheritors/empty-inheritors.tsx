...
const EmptyInheritors = ({ setConnectType }) => {
  return (
    <div className="mx-auto flex flex-col items-center w-full max-w-[542px] p-5 bg-[#FFFFFF] mt-16 rounded-[10px] shadow-sm">
      ...
      <button
        ...
        className="w-full bg-safekeep-blue rounded-lg py-4 mt-11 text-safekeep-white font-paralucentMedium text-sm leading-[14px]"
      >
        Add Inheritor
      </button>
    </div>
