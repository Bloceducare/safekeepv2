  ...
  return (
   <div className="w-full mx-auto max-w-[1100px] mt-8">
    ...
    <div className="mx-auto flex flex-col items-center w-full max-w-[542px] py-7 px-5 bg-[#FFFFFF] mt-16 rounded-[10px] shadow-sm">
        ...
        <p className="text-[#475467] text-sm text-center mt-1">We’re glad to have you onboard. Here are some quick tips to get you up and running.</p>
        <button className="w-full bg-safekeep-blue rounded-lg py-5 mt-5 text-safekeep-white font-paralucentMedium text-sm leading-[14px]">Connect Inheritors</button>
    </div>
