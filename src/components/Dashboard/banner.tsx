    ...
    <div className="w-full">
      ...
      <div className="w-full p-8 relative bg-safekeep-white rounded-lg">
        ...
        <div className="mt-9 flex flex-col lg:flex-row gap-4">
          <a
            href="/dashboard/deposit-token"
            className="flex w-full lg:max-w-[197px] gap-2.5 items-center rounded-lg bg-[#0171FD] justify-center p-4 text-safekeep-white font-paralucentMedium text-sm"
          >
            <ArrowDown />
            <p>Deposit Token</p>
          </a>
          <a
            href="/dashboard/withdraw-token"
            className="flex w-full lg:max-w-[197px] gap-2.5 rounded-lg border border-solid border-[#0171FD] items-center justify-center p-4 text-safekeep-blue font-paralucentMedium text-sm"
          >
