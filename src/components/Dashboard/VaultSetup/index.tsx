...
import IconOne from 'assets/images/create-vault-one.svg';
import IconTwo from 'assets/images/create-vault-two.svg';
import BackgroundOne from 'assets/images/vault-image-one.svg';
import BackgroundTwo from 'assets/images/vault-image-two.svg';
        ...
        <div className="flex flex-col">
          <div className="p-8 max-w-[835px] flex flex-col items-center w-full bg-safekeep-transparent rounded-[18px]">
            <div className="flex flex-col w-full lg:flex-row  gap-6 lg:gap-3 justify-between">
              <p className="leading-10 text-2xl order-2 lg:order-1 font-paralucentMedium text-[#011A91] tracking-tighter">
                Create Safevault 🚀
              </p>
            ...
            <div className="pt-6 lg:pt-16 flex flex-col lg:flex-row justify-between gap-4 w-full">
              <div className="w-full lg:max-w-[50%] relative z-0">
                <BackgroundOne className="absolute right-0 top-0 z-20" />
                <div className="relative flex flex-col justify-between items-start bg-safekeep-green-100 w-full h-[215px] lg:h-[336px] py-6 px-8 rounded-lg">
                  <div className="h-10 lg:h-[60px] rounded-lg flex items-center justify-center">
                    <IconOne />
                  </div>
                  <div>
                    <p className="text-[#090909] font-paralucentMedium text-xl lg:text-2xl lg:leading-8">
                      Already got a vault
                    </p>
                    <p className="font-dmSans text-[10px] leading-3 lg:leading-5 lg:text-sm pt-1">
                      Import your existing vault using your safevualt address.
                    </p>
                  </div>
                  <button className="block lg:hidden z-20 font-paralucentMedium rounded-lg text-sm leading-[14px] w-full py-2.5 border border-solid border-[#01A0FF] text-[#01A0FF]">
              ...
              <div className="w-full relative lg:max-w-[50%]">
                <BackgroundTwo className="absolute right-0 top-0 z-10" />
                <div className="relative flex flex-col justify-between items-start bg-safekeep-blue-100 w-full h-[215px] lg:h-[336px] py-6 px-8 rounded-lg">
                  <div className="h-10 w-auto lg:h-[60px] rounded-lg flex items-center justify-center">
                    <IconTwo />
                  </div>
                  <div>
                    <p className=" font-paralucentMedium text-xl lg:text-2xl lg:leading-8 text-safekeep-blue">
                      Create a Safevault
                    </p>
                    <p className="font-dmSans text-[10px] leading-3 lg:leading-5 lg:text-sm pt-1">
                      We would walk you through creating your Vault and through Safeguarding your assets.
                    </p>
                  </div>
                  <button
                    onClick={(e) => {
                    ...
                    className="block lg:hidden font-paralucentMedium rounded-lg text-sm leading-[14px] w-full py-2.5 bg-[#01A0FF] text-safekeep-white"
                  >
                    Create New Vault
                  </button>
                </div>
                <button
                  ...
                  className="hidden lg:block z-20 font-paralucentMedium rounded-lg mt-10 text-sm leading-[14px] w-full py-4 bg-[#01A0FF] text-safekeep-white"
                >
                  Create New Vault
                </button>
              </div>
          ...
          <button className="mt-14 w-full lg:max-w-[428px] mx-auto gap-4 flex items-center justify-center font-paralucentMedium py-3 text-safekeep-white text-[11px] lg:text-sm leading-4 bg-[#55A0FE] lg:bg-safekeep-blue-700 rounded-lg">
            <Information /> Your Vault is Built and Secured on Ethereum <Ethereum />
          </button>
        </div>
      )}
    </>
