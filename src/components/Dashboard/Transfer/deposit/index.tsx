...
const Deposit = () => {
  ...
  return (
    <div className="w-full">
              ...
              <div className="w-full lg:max-w-[542px] p-5 h-auto bg-safekeep-white rounded-lg">
                ...
                <div className="w-full relative flex mt-6 bg-[#FFFFFF] text-sm leading-4 font-medium border border-solid border-safekeep-blue-100 rounded">
                  <div className="w-full max-w-1/2 py-4 bg-safekeep-darky-blue flex items-center justify-center">
                    <p className="text-safekeep-white">From Wallet</p>
                  </div>
                ...
                <div className="w-full py-2 mt-6 px-4 bg-safekeep-hover">
                  ...
                  <div className="w-full mt-4 flex flex-row items-center justify-between">
                    <div className="w-full max-w-[151px] bg-safekeep-blue-100 rounded">
                      <Select
                        name="assetType"
                        className="flex items-center bg-safekeep-blue-100 rounded p-1 border-none focus:border-none "
                      >
                        <SelectOption value="usdt">
                    ...
                    <div className="w-full max-w-[151px]">
                      <Input
                        ...
                        name="amount"
                        placeholder="Amount"
                        className="h-full w-full max-w-[151px] bg-transparent hover:border-none focus:border-none  border-none font-dmSans text-2xl leading-6"
                      ></Input>
                    </div>
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="mt-5 w-full rounded-lg py-4 bg-safekeep-blue flex items-center justify-center font-paralucentMedium text-xs text-safekeep-white"
                >
                  Deposit
                </button>
              </div>
      ...
      {showModal && <DepositModal setShowModal={setShowModal} />}
    </div>
  );
};
