...
const Hero = () => {
  return (
    <div className="relative max-w-full w-full px:8 lg:px-0 lg:pt-40 pb-[353px] lg:pb-[410px]">
       <div className="lg:hidden relative w-full flex justify-end">
            <Image 
            alt="Hero Wheel"
            src={HeaderLogo}
            width="400"
     ...
     <div className="max-w-screen-2xl px-8 lg:px-9 w-full mx-auto z-50">
       <div className=" p-2 lg:p-0 tracking-tight lg:tracking-normal lg:max-w-[771px] w-full lg:ml-32 z-50 text-4xl  leading-[48px] font-paralucentMedium lg:text-[69px] lg:leading-[83px]">
        <span>One Vault to </span> <span>Inherit </span> <span>Cryptocurrency Anytime, Automatically.</span>
          ...
          <div className="mt-8 flex flex-col-reverse md:flex-row lg:mt-20 text-sm lg:text-lg leading-6">
            ...
            <button className="font-paralucentLight text-white px-24 py-3.5 bg-safekeep-blue rounded-lg mr-8 flex items-center justify-center"> <Wallet className="md:hidden mr-2.5" /> Get Safekeep</button>
          </div>
