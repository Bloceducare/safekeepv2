    ...
    <div className="max-w-screen-2xl mx-auto py-5  lg:py-[30px] flex flex-col w-full px-9 justify-between items-center text-center">
      <div className="pb-16 flex flex-col lg:flex-row justify-between w-full">
        ...
        <div className="max-w-[120px] mt-12 lg:mt-0 w-full">
          ...
          <p className="font-polySansTrial text-sm font-light text-safekeep-blue-400 w-full">Say Hi!, Sometime</p>
        </div>
      </div>
      <div className="w-full flex justify-between flex-col-reverse lg:flex-row mb-40 lg:mb-[286px]">
        ...
        <div className="max-w-[355px] w-full flex flex-col justify-start mb-9 lg:mb-0">
          <p
            className="font-polySansTrial text-sm pb-6 text-start"
            style={{
          ...
          <p className="text-start pt-2 font-polySansTrial text-xs text-safekeep-gray-500">No Spams, We promise ⚡️</p>
          <button className="font-paralucentLight max-w-[197px] w-full text-safekeep-white text-lg px-11 py-3.5 bg-safekeep-blue rounded-lg mt-10">Get Safekeep</button>
        </div>
      </div>
    </div>
  );
