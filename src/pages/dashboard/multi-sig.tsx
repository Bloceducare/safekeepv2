...
const MultiStatusBox = ({ btnAction = () => {}, title = '', description = '', buttonText = '', maxW = false }) => {
  return (
    <div>
      <div
        className={`bg-safekeep-white ${
          maxW ? '' : 'max-w-[32rem]'
        } m-auto p-5 text-center mt-8 rounded-lg border-safekeep-gray-200 border box-shadow-one`}
      >
      ...
      <div className="lg:grid grid-cols-10 gap-4  mt-4 flex flex-col-reverse ">
        <div className="col-span-6 bg-safekeep-white p-10 rounded-2xl lg:mb-0 mb-4">
          ...
          <p className="text-safekeep-gray-300 mt-3 mb-4 ">
            Add, remove and replace or rename existing Multisignatories. Wallet names are only stored locally and will
            never be shared with us or any third parties.
          </p>
          <ModalContent />
      ...
      <div className="max-w-4xl w-full">
        <div className="flex justify-between items-center ">
          <div className="flex items-center">
            <a href="/dashboard">
              <svg
                className="scale-[2] rounded-sm mr-5 bg-safekeep-white "
                width={15}
                height={15}
                viewBox="0 0 15 15"
                fill="none"
          ...
          <div>
            {isConnected ? (
              ...
              <button
                onClick={toggle}
                className="border-safekeep-blue rounded-md px-4 py-2 text-safekeep-blue-700 border"
              >
                Connect
              </button>
            )}
