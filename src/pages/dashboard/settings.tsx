...
const Settings = () => {
  return (
    <div className="w-full">
      ...
      <div className="lg:grid grid-cols-10 flex justify-center mt-12 gap-4">

        <div className="col-span-4 bg-safekeep-white p-5" >
          <div className="mb-8 text-lg text-safekeep-blue-500 font-paralucentMedium">
            Privacy
          </div>
         <div className="pl-2 font-polySansTrial">
         <div className="mb-8">
          ...
          <div className="col-span-6 bg-safekeep-white p-5" >
